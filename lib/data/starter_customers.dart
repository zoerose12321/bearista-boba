...
const starterCustomers = [
  ...
  BearCustomer(
    ...
    emoji: '🧸',
    order: DrinkOrder(
      ingredients: ['Black Tea', 'Milk', 'Boba Jelly'],
    ),
    happyMessage: 'Baby Bear does a happy wiggle! 🧸🍓',
    hintMessage: 'Baby Bear wanted black tea, milk, and boba jelly.',
  ...
  BearCustomer(
    ...
    emoji: '🐻‍❄️',
    order: DrinkOrder(
      ingredients: ['Green Tea', 'Milk', 'Tapioca Pearls'],
    ),
    happyMessage: 'Polar Bear gives an icy thumbs up! 🐻‍❄️❄️',
    hintMessage: 'Polar Bear wanted green tea, milk, and tapioca pearls.',
  ...
  BearCustomer(
    ...
    hintMessage: 'Sleepy Bear wanted black tea, milk, and tapioca pearls.',
